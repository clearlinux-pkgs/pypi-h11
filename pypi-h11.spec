...
Source0  : https://files.pythonhosted.org/packages/01/ee/02a2c011bdab74c6fb3c75474d40b3052059d95df7e73351460c8588d963/h11-0.16.0.tar.gz
...
%prep
%setup -q -n h11-0.16.0
cd %{_builddir}/h11-0.16.0
pushd ..
cp -a h11-0.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745503300
